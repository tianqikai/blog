...
public class SendmailUtil {
 ...
 //发件人邮箱
 public static final String myEmailAccount = "953811508@qq.com";
 
 //发件人邮箱密码（授权码）
 //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
 private static final String myEmailPassword = "vfzsitalabdebbbi";
 ...
 public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
  ...
  msg.setFrom(new InternetAddress(myEmailAccount,"tianqikai", "UTF-8"));
